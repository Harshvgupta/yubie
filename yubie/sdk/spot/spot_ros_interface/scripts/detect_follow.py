...
class Fetch():
    ...
    def __init__(self):
        ...
        self.principle_point_x = None
        self.principle_point_y = None
    ...
    def camera_callback(self,msg):
        self.cam_info = msg.K
        self.focal_length_x = self.cam_info[0]
        self.focal_length_y = self.cam_info[4]
        self.principle_point_x = self.cam_info[2]
        self.principle_point_y = self.cam_info[5]

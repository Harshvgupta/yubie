        ...
        try:
            with bosdyn.client.lease.LeaseKeepAlive(self.lease_client), bosdyn.client.estop.EstopKeepAlive(
                ...
                while not rospy.is_shutdown():
                    ...
                    img_reqs = [image_pb2.ImageRequest(image_source_name="frontleft_fisheye_image", image_format=image_pb2.Image.FORMAT_RAW,pixel_format=image_pb2.Image.PIXEL_FORMAT_RGB_U8)]
                    # img_reqs = [image_pb2.ImageRequest(image_source_name="frontright_fisheye_image", image_format=image_pb2.Image.FORMAT_RAW)]
                    # img_reqs = [image_pb2.ImageRequest(image_source_name="left_fisheye_image", image_format=image_pb2.Image.FORMAT_RAW)]
                    # img_reqs = [image_pb2.ImageRequest(image_source_name="right_fisheye_image", image_format=image_pb2.Image.FORMAT_RAW)]
                    # img_reqs = [image_pb2.ImageRequest(image_source_name="back_fisheye_image",image_source_name="right_fisheye_image", image_format=image_pb2.Image.FORMAT_RAW)]
